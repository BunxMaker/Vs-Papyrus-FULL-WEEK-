...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		var message:FlxText = new FlxText(690, 150,600,"",50);
		message.text = "You were excited about rap-battleing a very handsome skeleton and you needed to pause. I Understand";
